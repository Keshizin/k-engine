...
// extern IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(void* hWnd, void* msg, void* wParam, void* lParam);                // Use ImGui::GetCurrentContext()
// extern IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND param1, UINT param2, WPARAM param3, LPARAM param4);                // Use ImGui::GetCurrentContext()
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(void* hWnd, void* msg, void* wParam, void* lParam)
{
    ...
    UINT* m = static_cast<UINT*>(msg);
    WPARAM* wP = static_cast<WPARAM*>(wParam);
    LPARAM* lP = static_cast<LPARAM*>(lParam);

    return ImGui_ImplWin32_WndProcHandlerEx((HWND)hWnd, *m, *wP, *lP, ImGui::GetIO());
}
